...
You will be playing a game with no specific instructions about game controls, mechanics, or objectives. You are given the initial game state as an image. You will need to output a list of keys to press in each response. We will iterate the process by showing you the images from your actions and the score after the entire sequence of actions. 
